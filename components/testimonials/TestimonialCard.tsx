...
const TestimonialCard: React.FC<TestimonialCardProps> = ({
  ...
  return (
    <div className='border-primary/20 hover:border-primary/40 hover:shadow-[0_0_30px_rgba(46, 237, 170,0.3)] mb-6 flex w-[300px] max-w-[300px] transform flex-col gap-4 rounded-[8px] border bg-[#101010] p-6 shadow-xl transition-all duration-500 hover:scale-105'>
