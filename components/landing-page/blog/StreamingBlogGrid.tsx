            ...
            <div className='mb-8 flex gap-3 md:flex-row md:items-center md:justify-between lg:gap-16'>
              ...
              <div className='relative w-full md:min-w-[300px]'>
                ...
                <Input
                  ...
                  className='bg-background-card focus-visible:border-primary focus-visible:ring-primary/30 w-full rounded-lg border border-white/10 py-2 pr-4 pl-10 text-sm text-white placeholder:text-[#B5B5B5] focus:outline-none focus-visible:ring-[3px] md:h-[42px] md:text-base'
                  value={searchQuery}
