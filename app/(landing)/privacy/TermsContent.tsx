            ...
            <div className='space-y-6'>
              ...
              <div className='relative'>
                ...
                <input
                  ...
                  className='focus:border-primary focus:ring-primary w-full rounded-lg border border-[#2B2B2B] bg-[#101010] py-2.5 pr-4 pl-10 text-sm text-white placeholder:text-gray-500 focus:ring-1 focus:outline-none'
                />
              </div>
